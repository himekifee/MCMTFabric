...
public class SynchronisePlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        ...
        mixin2MethodsMap.put("net.himeki.mcmtfabric.mixin.ServerTickSchedulerMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_1949", "method_20514", "(Lnet/minecraft/world/ScheduledTick;)V"));
        mixin2MethodsMap.put("net.himeki.mcmtfabric.mixin.ServerTickSchedulerMixin", mappingResolver.mapMethodName("intermediary", "net.minecraft.class_1949", "method_8672", "(Lnet/minecraft/util/math/BlockBox;ZZ)Ljava/util/List;"));
